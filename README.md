...
> **Важно:** пункт GitHub **Code → Download ZIP** скачивает исходный код проекта, а не готовую пользовательскую production-версию. Готовое приложение скачивайте только как artifact **ORDERS_AUTO** из успешного workflow.
